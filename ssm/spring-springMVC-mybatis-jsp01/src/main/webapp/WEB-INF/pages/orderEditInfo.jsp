...
<div class='addOrderWrap'>
	...
	<form>
		<ul class='pop'>
			...
			<li class='flex ai-c jc-c'>
				<span>下单时间</span>
				<input type='text' name='orderTime' value='<fmt:formatDate value="${order.orderTime}" 
					pattern="yyyy/MM/dd HH:mm:ss"/>'/>
			</li>
			<li class='flex ai-c jc-c'>
				<span>结账时间</span>
				<input type='text' name='payTime' value='<fmt:formatDate value="${order.payTime}" 
					pattern="yyyy/MM/dd HH:mm:ss"/>'/>
			</li>
			<li class='flex ai-c jc-c'>
				<span>支付方式</span>
